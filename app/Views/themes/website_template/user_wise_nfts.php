        <div class="container">
            ...
            <div class="text-center mb-5">
                ...
                <div class="d-flex align-items-center justify-content-center mb-3">
                    ...
                    <!-- Verification icon -->
                    <div aria-hidden="true" class="verification-icon-wrap" data-bs-toggle="tooltip"
                ...
                <div class="fw-medium"><a><?php echo esc($userInfo->username); ?></a></div>
            ...
            <ul class="nav custom-tabs nav-tabs align-items-center mb-5">
                ...
                <li class="nav-item">
                    <a class="nav-link"><?php echo display('Activity'); ?></a>
                </li>
                        ...
                        <div class="d-flex filter mb-2">
                            <div class="dropdown me-2 nav-scroller-dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href="#"><?php echo display('Ethereum'); ?></a></li>
                                </ul>
                            </div>
                            <div class="dropdown me-2 nav-scroller-dropdown">
                                <button class="btn btn-filter dropdown-toggle" type="button"
